...
registerBlockType( 'editor-blocks/author-profile', {
	title: __( 'Author Profile (EB)', 'editor-blocks' ),
	description: __( 'Display a WordPress user’s profile dynamically using this block.', 'editor-blocks' ),
	...
	keywords: [
		__( 'Author Profile', 'editor-blocks' ),
		__( 'User', 'editor-blocks' ),
	],
